...
export default function Home() {
  ...
  const steps = [
    ...
    "Teste a conexão com o Lexos Hub",
      ...
      <header className="border-b bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Lexos Hub</h1>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <h2 className="text-5xl font-bold tracking-tight">
            ...
            <span className="text-primary">Lexos Hub</span>
          </h2>
            ...
            <Card className="bg-muted/50">
              ...
              <CardContent className="space-y-4">
                <div className="bg-background rounded-lg p-4 border">
                  ...
                  <p className="font-medium">"Manus, liste os pedidos pendentes do Lexos Hub"</p>
                </div>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © 2025 Integração Manus × Lexos Hub
            </p>

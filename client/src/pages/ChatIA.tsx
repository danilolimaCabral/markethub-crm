...
export default function ChatIA() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Olá! Sou seu assistente inteligente do Lexos Hub. Posso ajudá-lo com análises de dados, relatórios, previsões de vendas e muito mais. Como posso ajudar hoje?',
      timestamp: new Date()
    }
  ]);
...
Com base nos dados do Lexos Hub, aqui está uma análise detalhada:
...
Como assistente IA integrado ao Lexos Hub, posso ajudá-lo com:
